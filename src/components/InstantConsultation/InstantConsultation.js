...
const InstantConsultation = () => {
    ...
    useEffect(() => {
        getDoctorsDetails(); // eslint-disable-line no-unused-vars
        const authtoken = sessionStorage.getItem("auth-token");
        if (!authtoken) {
        navigate("/login"); // eslint-disable-line no-unused-vars
        }
    }, [searchParams, navigate, getDoctorsDetails]) // eslint-disable-line no-unused-vars
